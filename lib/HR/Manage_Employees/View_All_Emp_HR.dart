...
class AllEmployees_HR extends StatefulWidget {
  @override
  _AllEmployees_HRState createState() => _AllEmployees_HRState();
}

class _AllEmployees_HRState extends State<AllEmployees_HR> {
  ...
  navigateToDetail(DocumentSnapshot post) {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => EmpDetailPage_HR(
                  post: post,
                )));
  }
  ...
  Widget EmployeeListWidget() {
    return StreamBuilder(
      stream: firestore
          ...
          .where(empType, isNotEqualTo: "Admin")
          .snapshots(),
