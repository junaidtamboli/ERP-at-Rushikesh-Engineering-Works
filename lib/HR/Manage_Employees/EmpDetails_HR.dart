...
import 'package:rushikesh_engg/HR/Manage_Employees/Update_Emp_Profile_HR.dart';
import 'package:rushikesh_engg/theme.dart';

class EmpDetailPage_HR extends StatefulWidget {
  final DocumentSnapshot post;
  EmpDetailPage_HR({required this.post});
  @override
  _EmpDetailPage_HRState createState() => _EmpDetailPage_HRState();
}

class _EmpDetailPage_HRState extends State<EmpDetailPage_HR> {
