...
import 'package:rushikesh_engg/HR/Manage_Employees/SelectedCandidates.dart';
import 'package:rushikesh_engg/HR/Manage_Employees/View_All_Emp_HR.dart';
import 'package:rushikesh_engg/theme.dart';

class Manage_Employee_HomePage extends StatefulWidget {
  @override
  Manage_Employee_HomePageState createState() =>
      Manage_Employee_HomePageState();
}

class Manage_Employee_HomePageState extends State<Manage_Employee_HomePage> {
  ...
  switch (val) {
    case 1:
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => SelectedCandidates()));
      break;

    case 2:
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => AllEmployees_HR()));
      break;
    default:
  }
}
