...
class Add_New_Candidate extends StatefulWidget {
  @override
  _Add_New_CandidateState createState() => _Add_New_CandidateState();
}

class _Add_New_CandidateState extends State<Add_New_Candidate> {
                        ...
                        onTap: () => {
                          if (_formKey.currentState!.validate() &&
                              dob.text.isNotEmpty)
                            {
                              ...
                              createCandidateProfile(context),
                            }
  ...
  createCandidateProfile(BuildContext context) async {
    print("reach");
    Fluttertoast.showToast(msg: "dob is " + dob.text);
    String res = await appMethod.createCandidateProfile(
      name: name.text,
    ...
    if (res == successful) {
      showSuccessDialog(context, "Profile Created", res);
    } else {
      showErrorDialog(context, "Failed to candidate profile", res);
    }
  }
}
