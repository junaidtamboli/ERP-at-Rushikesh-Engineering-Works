...
class Manage_Clients_HomePage extends StatefulWidget {
  @override
  Manage_Clients_HomePageState createState() =>
      new Manage_Clients_HomePageState();
}

class Manage_Clients_HomePageState extends State<Manage_Clients_HomePage> {
  @override
