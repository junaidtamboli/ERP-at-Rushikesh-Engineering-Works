...
class ProjectDetailPage_ProjManager extends StatefulWidget {
  final DocumentSnapshot post;
  ProjectDetailPage_ProjManager({required this.post});
  @override
  _ProjectDetailPage_ProjManagerState createState() =>
      _ProjectDetailPage_ProjManagerState();
}

class _ProjectDetailPage_ProjManagerState
    extends State<ProjectDetailPage_ProjManager> {
                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => UpdateTeamLeader(
                                    post: widget.post,
                                  ),
                                ),
                              );
...
void showTeamLeaderInfoDialog(BuildContext context, Map<String, dynamic> data) {
  // ignore: avoid_single_cascade_in_expression_statements
  AwesomeDialog(
    context: context,
    dialogType: DialogType.INFO_REVERSED,
