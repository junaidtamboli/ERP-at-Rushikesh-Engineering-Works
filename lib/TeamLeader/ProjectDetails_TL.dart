...
import 'package:rushikesh_engg/Project_Manager/UpdateTeamLeader.dart';
import 'package:rushikesh_engg/TeamLeader/UpdateStatus.dart';
import 'package:rushikesh_engg/TeamLeader/UpdateTeamMembers.dart';
import 'package:rushikesh_engg/theme.dart';

class ProjectDetailPage_TL extends StatefulWidget {
  final DocumentSnapshot post;
  ProjectDetailPage_TL({required this.post});
  @override
  _ProjectDetailPage_TLState createState() => _ProjectDetailPage_TLState();
}

class _ProjectDetailPage_TLState extends State<ProjectDetailPage_TL> {
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Status : ${widget.post[projStatus]}",
                      style: regular18pt.copyWith(color: textBlack),
                    ),
                    const SizedBox(
                      height: 20,
                    ),
                    widget.post[projStatus] != "Deployed"
                        ? Material(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => UpdateTeamMembers(
                                          post: widget.post,
                                        ),
                                      ),
                                    );
